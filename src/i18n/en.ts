...
export const en = {
  ...
  'cmd.model': 'Switch model — bare to pick from the live list',
  ...
  'modelpicker.title': 'Models on {label}',
  ...
  'notice.modelListFailed':
    'Could not fetch the model list from the endpoint — showing known models. You can also type an id manually.',
