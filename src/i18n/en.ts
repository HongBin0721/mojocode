...
export const en = {
  ...
  'perm.inDir': 'in {dir}',
  'perm.skillRules': 'Skill "{name}" asks to pre-approve these rules for this session',
  ...
  'reviewpick.branchTitle': 'Pick a base branch',
  'reviewpick.commitTitle': 'Pick a commit to review',
