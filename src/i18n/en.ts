...
export const en = {
  ...
  'goal.progress': 'goal {turn}/{max}',
  'goal.evaluating': 'checking',
  ...
  'settings.hint': '↑/↓ select · enter open · esc close',
  ...
  'reviewopt.uncommittedTitle': 'Review uncommitted changes',
  'reviewopt.uncommittedDesc': 'Reviews staged, unstaged, and untracked files in your working tree',
  'reviewopt.commitTitle': 'Review a commit',
  'reviewopt.commitDesc': 'Pick a commit from recent history and review it',
  'reviewopt.customTitle': 'Custom review instructions',
  'reviewopt.customDesc': 'Describe what to focus on; reviews uncommitted changes',
  'cmd.goal': 'Keep working until a condition is met — /goal <condition>, /goal, /goal clear',
  'cmd.models': 'Switch model across configured providers — grouped, searchable',
  'cmd.provider': 'Switch provider — bare to pick',
  'cmd.setting': 'Open the settings panel — language, status bar',
  ...
  'cmd.theme': 'Color theme — /theme <name> (default = built-in colors)',
  'themeopt.default': 'Built-in colors',
  ...
  'cmd.reload': 'Reload extensions from disk (builtin ones stay)',
  'notice.reloaded': 'Extensions reloaded: {loaded} ({failed} failed).',
  'notice.reloadFailed': 'Failed to reload extensions: {message}',
  'cmd.skills': 'Rescan and list skills (SKILL.md in .mojocode/skills or .claude/skills)',
  ...
  'notice.skillsList': 'Skills:\n{list}',
  'notice.skillsNone':
    'No skills found. Put a SKILL.md in .mojocode/skills/<name>/ or .claude/skills/<name>/.',
  'notice.skillsFailed': 'Failed to scan skills: {message}',
  'notice.skillRunFailed': 'Skill failed: {message}',
  ...
  'notice.themeUsage': 'Usage: /theme <{list}> (currently: {current})',
  'notice.themeSet': 'Theme is now {name}.',
  'notice.themeNotFound': 'Theme "{name}" not found.',
  'notice.themeSaveFailed': 'Could not save theme: {message}',
  ...
  'notice.hookFailed': 'Extension hook {hook} failed: {message}',
  ...
  'notice.reviewNoRepo': 'Not a git repository — /review needs one.',
  'notice.reviewCleanTree': 'Nothing to review: the working tree is clean.',
  'notice.reviewNoCommits': 'Nothing to review: this repository has no commits yet.',
  'notice.reviewNoDiff': 'Nothing to review: no changes since the merge-base with {branch}.',
  'notice.reviewNoBranches': 'No other local branches to compare against.',
  'notice.reviewUnknownCommit': 'No commit matches "{sha}".',
  'notice.reviewUnknownBranch': 'No local branch named "{branch}".',
  'notice.reviewSameBranch': '{branch} is the current branch — pick a different base.',
  'notice.reviewNoMergeBase': '{branch} shares no history with the current branch.',
  ...
  'cli.opt.extension': 'load an extension file or directory (repeatable)',
  'cli.opt.flag': 'pass a flag to extensions: -X name or -X name=value (repeatable)',
  'cli.cmd.install': 'Install an extension package: npm:<name>, git:<url>, or a local directory',
  'cli.cmd.remove': 'Remove an installed extension package',
  'cli.cmd.extensions': 'List the extensions and packages that would be loaded from this workspace',
  'cli.opt.packageLocal': 'install into this workspace (<root>/.mojocode) instead of ~/.mojocode',
  'cli.installed': 'Installed {name} → {dir}\nRecorded in {file}',
  'cli.removed': 'Removed {name} (updated {file})',
  'cli.removeNotFound': 'No installed package named "{name}". `mojocode extensions` lists them.',
  'cli.noExtensions': 'No disk extensions found. Put a *.ts or *.js file in ~/.mojocode/extensions/ or <root>/.mojocode/extensions/, or run `mojocode install`.',
  'cli.extensionsHeader': 'Extensions (in load order):',
  'cli.packagesHeader': 'Packages:',
  'cli.packageMissingRow': '  ✗ {spec}  (not on disk — run `mojocode install {spec}` again)',
  'notice.extensionPathMissing': 'Extension path given with `-e` does not exist: {file}',
  'notice.extensionLoadFailed': 'Extension "{id}" failed to load ({file}): {message}',
  'notice.extensionDuplicate': 'Extension "{id}" ({file}) skipped: another extension with that id is already loaded.',
  'notice.packageMissing': 'Package "{spec}" is recorded in the config but not on disk — run `mojocode install {spec}` again.',
  ...
  'doctor.section.skills': 'Skills',
  'doctor.check.skillsCount': 'Discovered',
  'doctor.check.skillsSources': 'Sources',
  'doctor.check.skillsParse': 'Parse failures',
  'doctor.skillsCount': '{n} skills · {user} user-invocable · {model} model-invocable',
  'doctor.skillsNone': 'none (SKILL.md in .mojocode/skills/<name>/ or .claude/skills/<name>/)',
  ...
  'doctor.mcpOff': 'MCP extension not loaded in this session (--no-mcp)',
  ...
  'auth.other': 'Other — custom OpenAI-compatible endpoint',
  'auth.customUrl': 'Base URL of the OpenAI-compatible endpoint',
  'auth.customUrlHint': 'e.g. https://openrouter.ai/api/v1 · http://127.0.0.1:11434/v1',
  'auth.customUrlConfirm': 'enter confirm · esc back',
  'auth.invalidUrl': 'Enter a valid http(s) URL',
  'auth.enterKey': 'Paste the API key for {label}',
  'auth.enterKeyHint': 'enter confirm · esc back',
  'auth.enterKeyOptionalHint': 'enter confirm · empty for local endpoints · esc back',
  ...
  'auth.validated': 'Validated — {n} models available.',
  'auth.unverifiedPick': 'Key not verified — it will be saved with your model choice.',
  'auth.saveFailed': 'Save failed: {message}',
  'auth.plaintextWarn': 'Note: the key is stored in plain text in {path}. Prefer env vars on shared machines.',
  'auth.pickModelTitle': 'Pick a model for {id}',
  'auth.savedDefault': 'provider {id} · model {model} — set as default',
  ...
  'modelpicker.manual': 'Type a model id…',
  'modelpicker.manualHint': 'enter confirm · esc back to the list',
  'modelpicker.context': 'context {n}',
  'modelspicker.title': 'Models — grouped by provider',
  'modelspicker.search': 'type to search…',
  'modelspicker.hint': 'type to search · ↑/↓ move · enter pick/expand · ←/→ collapse/expand · esc back',
  'modelspicker.count': '{n} models',
  'modelspicker.fetchFailed': 'model list unavailable',
  'modelspicker.noMatches': 'no matching models',
  'modelspicker.manual': 'Type a model id for {label}…',
  'notice.modelsUnavailable': 'Could not fetch provider model lists — only manual entry is available.',
  'providerpicker.title': 'Switch provider',
  'providerpicker.noKey': 'no key',
  'providerpicker.keyOptional': 'no key needed (local)',
  'providerpicker.enterHintOptional': 'enter confirm · empty to skip · esc back',
